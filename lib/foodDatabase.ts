...
export const FOOD_DB: readonly FoodDBItem[] = [
  ...
  { id: 'ovo_c',     name: 'Ovo cozido',                cal: 155, p: 13,  c: 1.1, f: 11,  serving: 60  },
  { id: 'ovo_m',     name: 'Ovo mexido',                cal: 148, p: 10,  c: 1.6, f: 11,  serving: 60  },
  ...
  // ── FRUTAS ───────────────────────────────────────────────────
  { id: 'banana',    name: 'Banana',                   cal: 89,  p: 1.1, c: 23,  f: 0.3, serving: 120 },
  { id: 'maca',      name: 'Maçã',                     cal: 52,  p: 0.3, c: 14,  f: 0.2, serving: 150 },
  { id: 'laranja',   name: 'Laranja',                  cal: 47,  p: 0.9, c: 12,  f: 0.1, serving: 150 },
  { id: 'manga',     name: 'Manga',                    cal: 60,  p: 0.8, c: 15,  f: 0.4, serving: 150 },
  ...
  { id: 'pera',      name: 'Pêra',                     cal: 57,  p: 0.4, c: 15,  f: 0.1, serving: 150 },
  { id: 'kiwi',      name: 'Kiwi',                     cal: 61,  p: 1.1, c: 15,  f: 0.5, serving: 80  },
  ...
  { id: 'tomate',    name: 'Tomate',                   cal: 18,  p: 0.9, c: 3.9, f: 0.2, serving: 100 },
  ...
  { id: 'cast_b',    name: 'Castanha-do-pará',         cal: 659, p: 14,  c: 12,  f: 66,  serving: 20  },
  ...
  { id: 'pizza_sl',  name: 'Pizza (fatia média)',      cal: 266, p: 11,  c: 33,  f: 10,  serving: 100 },
