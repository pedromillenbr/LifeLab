...
export function BibleIllustration() {
  ...
  return (
    <svg className="bible-svg" width="130" height="200" viewBox="0 0 130 200" fill="none" style={{ overflow: 'visible' }}>
      ...
      {[0, 1, 2, 3, 4].map(i => (
        <circle key={i} cx={36 + i * 12} r="1.5" fill="rgba(234,179,8,0.6)">
      ...
      <line x1="22" y1="24" x2="22" y2="138" stroke="rgba(234,179,8,0.4)" strokeWidth="1.2" />
      <rect x="102" y="16" width="4" height="130" rx="1" fill="rgba(255,255,255,0.05)" />
      <rect x="16" y="14" width="88" height="4" rx="3" fill="rgba(234,179,8,0.22)" />
      <rect x="16" y="144" width="88" height="4" rx="3" fill="rgba(234,179,8,0.22)" />
      <rect x="16" y="14" width="88" height="134" rx="7" fill="none" stroke="rgba(234,179,8,0.5)" strokeWidth="1.4" />
      <rect x="34" y="26" width="62" height="110" rx="4" fill="none" stroke="rgba(234,179,8,0.14)" strokeWidth="1" />
      <rect x="61" y="44" width="10" height="54" rx="3.5" fill="rgba(234,179,8,0.95)" filter="url(#crossGlow)" />
      <rect x="44" y="60" width="44" height="10" rx="3.5" fill="rgba(234,179,8,0.95)" filter="url(#crossGlow)" />
      <rect x="61" y="44" width="10" height="54" rx="3.5" fill="rgba(234,179,8,0.3)" style={{ filter: 'blur(8px)' }} />
      <rect x="44" y="60" width="44" height="10" rx="3.5" fill="rgba(234,179,8,0.3)" style={{ filter: 'blur(8px)' }} />
      <rect x="42" y="108" width="48" height="5" rx="2.5" fill="rgba(234,179,8,0.38)" />
      <rect x="48" y="118" width="36" height="4" rx="2" fill="rgba(234,179,8,0.2)" />
      <rect x="54" y="126" width="24" height="3" rx="1.5" fill="rgba(234,179,8,0.12)" />
